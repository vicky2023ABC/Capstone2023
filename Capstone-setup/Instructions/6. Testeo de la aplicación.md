...
El primer flujo de trabajo que revisaremos es el punto de conexión de Registro. En este punto de conexión, un nuevo usuario se registra proporcionando información de inicio de sesión, como nombre de usuario y contraseña, así como atributos para su usuario, como altura y peso.
...
Ya vimos la función createCognitoUser en el módulo de Amazon Cognito, así que no la repetiremos aquí. Veamos la función createUser, que se puede encontrar en application/data/createUser.js.
...
Intentamos invocar tu punto de conexión de Registro para crear un nuevo usuario. Ejecuta el siguiente comando en tu terminal:
...
## Paso 3. Añadir elementos a tu usuario
...
Intentemos usar este punto de conexión. Ejecuta el siguiente comando en tu terminal:
...
Ten en cuenta que estás pasando nuestro token de ID en la cabecera de Autorización con tu solicitud.
...
¡Se ha añadido este nuevo elemento a nuestro usuario! Ten en cuenta que las propiedades impresas para ti serán ligeramente diferentes, ya que el tipo y las propiedades del objeto son aleatorios.
